...
namespace eDoctor.Migrations
{
    ...
    public partial class AddDoctor : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SectionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SectionTitle = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Introductions_Sections_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_LoginName",
                table: "Doctors",
                column: "LoginName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Introductions_DoctorId_SectionId",
                table: "Introductions",
                columns: new[] { "DoctorId", "SectionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Introductions_SectionId",
                table: "Introductions",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Sections_SectionOrder",
                table: "Sections",
                column: "SectionOrder",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sections_SectionTitle",
                table: "Sections",
                column: "SectionTitle",
                unique: true);
        }
